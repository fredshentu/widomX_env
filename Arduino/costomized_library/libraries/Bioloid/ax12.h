...
// Fred's code, modify this library to support torque control for MX series
#define TorqueEnable(id) (ax12SetRegister(id, MX_TORQUE_ENABLE, 1))//once enable, can not disable
//For the torque, 0~1023 ccw, 0 stop, 1024~2047 cw, 1024 stop
#define mx_SetTorque(id, torque) (ax12SetRegister2(id, MX_GOAL_TORQUE_L, torque))
