...
EPOCH_LENGTH = 600
cam_HD_pub = rospy.Publisher("episode_sync", Int16MultiArray, queue_size = 1)
def sample(index):
    ...
    cam_HD_pub_data.data = [1, index]
    cam_HD_pub.publish(cam_HD_pub_data)
    time.sleep(0.08)
